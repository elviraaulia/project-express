...
// const atau let itu digunakan untuk mendeklarasikan sebuah variable/ object/array/function
const luasLingkaran = (request: Request, response: Response) => {
    // digunakan untuk menangani jika code mengalami kesalahan secara logic
    // try berisi code
    // catch untuk menghandle codingan yang error dengan lebih rapi
    try {
        const phi = Math.PI
